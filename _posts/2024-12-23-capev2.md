...
DHCP-сервер VirtualBox в Типе подключения адаптера - NAT присвоит серверу FOG IP-адрес 10.0.2.15. Этот адрес мы будем использовать далее в NatNetwork.
...
В менеджере сетей  VirtualBox во вкладке Сети NAT выбираем NatNetwork и отключаем DHCP-сервер, т.к. DHCP-сервер будет работать на сервере FOG. Выход в сеть Интернет отсутствует.
![](/images/capev2/Pasted%20image%2020241222232220.png)

В настройках адаптера ubuntu-fog выбираем Сеть NAT - NatNetwork
![](/images/capev2/Pasted%20image%2020241222232415.png)

В операционной системе ubuntu-fog присваиваем статический IP-адрес 10.0.2.15
...
В настройках адаптера windows 10 выбираем Сеть NAT - NatNetwork
![](/images/capev2/Pasted%20image%2020241223005259.png)


В операционной системе машине для анализа присваиваем статический IP-адрес 10.0.2.16, шлюзом будет IP-адрес машины с CAPE 10.0.2.17
...
В настройках адаптера ubuntu-cape2 выбираем Cеть NAT- NatNetwork
![](/images/capev2/Pasted%20image%2020241223173023.png)

В операционной системе ubuntu-cape2 присваиваем статический IP-адрес 10.0.2.17
![](/images/capev2/Pasted%20image%2020241224104816.png)
