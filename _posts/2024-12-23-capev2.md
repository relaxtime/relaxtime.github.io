...
Далее меняем сетевые настройки адаптера

Гостевая машина 10-Настроить-Сеть-Адаптер1
![](/images/capev2/Pasted%20image%2020241224170341.png)
![](/images/capev2/Pasted%20image%2020241224171258.png)
...
netstat -ano
```
![](/images/capev2/Pasted%20image%2020241224171556.png)
...
Устанавливаем приоритет загрузки по сети
...
![](/images/capev2/Pasted%20image%2020241224183847.png)
![](/images/capev2/Pasted%20image%2020241224184222.png)

После этого будут доступны результаты анализа
![](/images/capev2/Pasted%20image%2020241224184307.png)

После завершения на машине для анализа запустится клиент FOG, а на FOG-сервере появится новая задача, которая отвечает за перезапуск машины и развертывание на ней образа.
