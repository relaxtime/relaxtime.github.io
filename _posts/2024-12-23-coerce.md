...
#### Рекомендации
Отключить службу печати на всех объектах ЛВС, где использование указанной службы не требуется. Скорректировать правила межсетевого экранирования на уровне приложений на объектах, входящих в состав домена
...
https://gazeta.krl-uprava.ru/novyj-master-klass-ot-studii-teatrusha-posvjaschen-sozdaniju-kukly-marionetki
